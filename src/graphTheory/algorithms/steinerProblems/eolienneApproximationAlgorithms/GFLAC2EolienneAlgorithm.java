 ...
 * 
 */
public class GFLAC2EolienneAlgorithm extends EolienneApproximationAlgorithm {
	...
	private boolean findConflict(Integer u, Integer v) {
		if (unionFind.connected(u-1, v-1))
			return true;
		return !checkCapacities(u, getFlowRate(v));
	}
	...
	private boolean checkCapacities(Integer u, int k){
		...
		while(!toCheck.isEmpty()){
			...
			while(it.hasNext()) {
                ...
                System.out.println(b+" "+capacity+" "+getFlowRate(w)+" "+k);
