...
/**
 * 
 * Define the graphical arrow representation of the ending of an arc.
 * Its ending is defined by two parameters: the angle {@link #beta}
 * of the tip of the arrow, and the lenght {@link #sideDistance} of that tip 
 * 
