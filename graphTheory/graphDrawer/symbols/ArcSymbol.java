...
/**
 * 
 * This abstract class define the graphical representation of an arc.
 * It may be a line, or a circular curve for instance.
 * 
...
public abstract class ArcSymbol {
	 ...
	 * angle separating the segment linking 
	 * its two endings and the tangent of the curve at one of the endings.
	 */
