...
/**
 * Implementation of a FibonnacciHeap, from http://jgrapht.sourceforge.net/
 * with a little difference.
 * 
 * In the original version, each key had to be a double. It is here
 * a subClass of the Comparable2 abstract class. It means that each
 * key can be compared to another, and that it exits a positive
 * infinity key and a negative infinity key.
 * 
 */
public class CustomFibonacciHeap<Data, Key extends Comparable2<Key>>
{
    ...
    {
    	CustomFibonacciHeapNode<Data, Key> node = new CustomFibonacciHeapNode<Data, Key>(data, key);
    ...
    public static <T, W extends Comparable2<W>> CustomFibonacciHeap<T,W> union(
        CustomFibonacciHeap<T,W> h1,
        CustomFibonacciHeap<T,W> h2)
    {
    ...
    protected void consolidate()
    {
        ...
        List<CustomFibonacciHeapNode<Data,Key>> array =
            new ArrayList<CustomFibonacciHeapNode<Data,Key>>(arraySize);
     ...
     */
    protected void cut(CustomFibonacciHeapNode<Data,Key> x, CustomFibonacciHeapNode<Data,Key> y)
    {
     ...
     */
    protected void link(CustomFibonacciHeapNode<Data,Key> y, CustomFibonacciHeapNode<Data,Key> x)
    {
