...
/**
 * Implementation of a node of FibonnacciHeap, from http://jgrapht.sourceforge.net/
...
public class CustomFibonacciHeapNode<Data,Key extends Comparable2<Key>>
{
    ...
    public LinkedList<CustomFibonacciHeapNode<Data,Key>> children() {
    	LinkedList<CustomFibonacciHeapNode<Data, Key>> l = 
    			new LinkedList<CustomFibonacciHeapNode<Data,Key>>();
    	l.add(this);
    	CustomFibonacciHeapNode<Data,Key> y,x = this.child; y=x;
    	if(x != null){
    	do{
    		l.addAll(x.children());
    		x = x.right;
