...
/**
 * This class implements an iterator over more than one collection.
 * It firstly iterates every elements of the first one, then
 * the second one, ... until it has iterated the last element of the
 * last collection.
 * <br/>
 * It acts as every collections were concatenated and then iterated.
 * <br/>
...
public class MultiIterator<T> implements Iterator<T> {
	...
	/**
	 * Return an iterator over every collection iterated by
	 * the iterators in the list iterators.
	 * @param iterators
	 */
	@SafeVarargs
