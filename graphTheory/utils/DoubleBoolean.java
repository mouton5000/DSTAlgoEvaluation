 ...
 * 
 * This couple extends the {@link Comparable2} abstract class, as any two couples
 * can be compared. The doubles are firstly compared. If equals, the booleans are
 * compared. True is bigger than False.
 * 
...
public class DoubleBoolean extends Comparable2<DoubleBoolean>{
	 ...
	 */
	public static final DoubleBoolean POSITIVE_INFINITY = new DoubleBoolean(Double.POSITIVE_INFINITY, true);
	
	/**
	 * The smallest couple of double and boolean 
	 */
	public static final DoubleBoolean NEGATIVE_INFINITY = new DoubleBoolean(Double.NEGATIVE_INFINITY, false);
