...
/**
 * This class represent a Graph, with its vertices and
 * its arcs or edges (depending those are directed or not).
 */
public class Graph implements Parametable {
	...
	/**
	 * Set of virtually removed vertices.
	 * Those vertices do not appear while reading the graph.
	 */
	...
	/**
	 * Set of virtually removed edges and arcs.
	 * Those edges do not appear while reading the graph.
	 */
	protected Set<Arc> vrmEdges;

	/**
	 * Association between a node and the lists
	 * of directed arcs entering it, directed arcs outgoing from it
	 * and undirected arcs linked to it.
	 * <br/>
	 ...
	 * O(|Number of nodes|)
	 * 
	 * @return An ArrayList containing every node of this, excluding the virtually removed vertices.
	 ...
	 * O(|Number of nodes|)
	 * 
	 * @return A LinkedList containing every node of this, excluding the virtually removed vertices.
	 * @see #virtuallyRemoveVertice(Integer)
	 */
	 ...
	 * O(|Number of nodes|)
	 * 
	 * @return An HashSet containing every node of this, excluding the virtually removed vertices.
	 * @see #virtuallyRemoveVertice(Integer)
	 */
	 ...
	 * 
	 * @return An ArrayList containing every edge or arc of this, 
	 * excluding the virtually removed arcs and edges.
	 ...
	 * O(|Number of edges + arcs|)
	 * 
	 * @return A LinkedList containing every edge or arc of this, 
	 * excluding the virtually removed arcs and edges.
	 * @see #virtuallyRemoveEdge(Arc)
	 */
	 ...
	 * O(|Number of edges + arcs|)
	 * 
	 * @return An HashSet containing every edge or arc of this, 
	 * excluding the virtually removed arcs and edges.
	 * @see #virtuallyRemoveEdge(Arc)
	 */
	...
	/*
	 * ---------------------------------------------
	 * Iterate on the vertices and the edges
	 * ---------------------------------------------
	 */

	/**
	 * @return A ListIterator over the list of nodes in this. The order
	 * of this iterator is by default the order of insertion of each node.
	 * If the methods {@link #sortVertices()} or {@link #sortVertices(Comparator)}
	 * were called, this order is used instead.
	 * 
	 * @see #sortVertices()
	 * @see #sortVertices(Comparator)
	 */
	public Iterator<Integer> getVerticesIterator() {
		return new PartialIterator<Integer>(vertices, new Foncteur<Integer, Boolean>() {
	 ...
	 * of this iterator is by default the order of insertion of each edge and arc.
	 * If the methods {@link #sortEdges()} or {@link #sortEdges(Comparator)}
	 * were called, this order is used instead.
	 * 
	 * @see #sortEdges()
	...
	/**
	 * @return The neighbour of n in this linked with a 
	 * or null if either n or a do not belong to this or
	 * if n do not belong to a, or if a or n are virtually removed.
	 */
	...
	/**
	 * Return the (n1,n2) directed arc, the (n1,n2) undirected arc, or the (n2, n1) undirected
	 * arc in this. If more than one arc link those nodes, the directed ones are returned in priority. There is no
	 * mean to know which one is returned if there are more than one directed arc, or more than one undirected edge and
	 * no directed arc. If there is no arc, null is returned.
	 * 
	 * @param n1
	 * @param n2
	 * @return An arc or edge linking n1 and n2, 
	 * null if no link exists or if n1 or n2 does not belong to this, or
	...
	/**
	 * 
	 * @return True if it exists a (n1,n2) directed arc, a (n1,n2) 
	 * undirected edge, or a (n2, n1) undirected edge in this. False
	 * if not or if no link exists or f n1 or n2 does not belong to this,
	...
	/**
	 * Return the (input,output) directed arc in this. If more than one arc link those nodes, there is no
	 * mean to know which one is returned. If there is no arc, null is returned.
	 * 
	 * @param input
	 * @param output
	 * @return An arc linking input and output, null if no link exists or f n1 or n2 does not belong to this,
	 * or are virtually removed. 
	 */
	...
	/**
	 * @return True if it exists a (input,output) directed arc in this.
	 * False if not or if no link exists or f n1 or n2 does not belong to this,
	 * or are virtually removed.  
	 */
	...
	/**
	 * Return the (n1,n2) undirected edge, or the (n2, n1) undirected
	 * edge in this. If more than one arc link those nodes, there is no
	 * mean to know which one is returned if there are more than one undirected edge. 
	 * If there is no edge, null is returned.
	 * 
	 * @param n1
	 * @param n2
	 * @return An edge linking n1 and n2, null if no link exists or if n1 or n2 does not belong to this,
	 * or are virtually removed. 
	 */
	 ...
	 * 
	 * @return True if it exists a (n1,n2) directed arc, a (n1,n2) 
	 * undirected edge, or a (n2, n1) undirected edge in this.
	 * False if not or if n1 or n2 does not belong to this,
	 * or are virtually removed. 
	 */
	...
	/**
	 * @param n
	 * @return The list of arcs keyed by the node n in links.
	 * Null if n do not belong to this graph,
	 * or is virtually removed. 
	 */
	private Triplet<Set<Arc>,Set<Arc>,Set<Arc>> getLinks(Integer n){
		if(this.hasVirtuallyRemoved(n))
			return null;
		Triplet<Set<Arc>,Set<Arc>,Set<Arc>> nodeLinks = 
				links.get(n);
		return nodeLinks;
	}
	...
	/*
	 * ---------------------------------------------
	 * Get access to directed input neighbours
	 * ---------------------------------------------
	 */
	...
	/**
	 * @param n
	 * @return The list of directed arcs entering this node in this,
	 * including the virtually removed edges. Null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	 ...
	 * getInputArcs(n) returns all the (-,n) directed arcs of this.
	 * It returns null if n do not belong to this. 
	 * 
	 * @return An ArrayList of directed arcs entering this node in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	/**
	 * @return The number of arcs entering n in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	/**
	 * @param n
	 * @return a list iterator over the arcs entering n in this
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	/**
	 * @return An ArrayList containing the nodes m linked 
	 * to the node n with a directed (m,n) arc, null 
	 * if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	/**
	 * @return A LinkedList containing the nodes m linked 
	 * to the node n with a directed (m,n) arc,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	/**
	 * @return An HashSet containing the nodes m linked 
	 * to the node n with a directed (m,n) arc,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	/*
	 * ---------------------------------------------
	 * Get access to output neighbours
	 * ---------------------------------------------
	 */
	 ...
	 * Return t
	 * @param n
	 * @return The list of arcs keyed by the node n in outputs, 
	 * null if n do not belong to this graph.
	 */
	...
	/**
	 * @return The number of arcs outgoing from n in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	/**
	 * @param n
	 * @return a list iterator over the arcs outgoing from n in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	/**
	 * @return An ArrayList containing the nodes m linked 
	 * to the node n with a directed (n,m) arc,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	/*
	 * ---------------------------------------------
	 * Get access to undirected neighbours
	 * ---------------------------------------------
	 */

	/**
	 * @param n
	 * @return The list of arcs keyed by the node n in undirectedNeighbour,
	 * null if n do not belong to this graph.
	 */
	...
	private boolean fillWithUndirectedNeighbourArcs(Integer n, Collection<Arc> col){
	 ...
	 * getUndirectedNeighbourEdges(n) returns all the (-,n) and (n,-) undirected edges of this. 
	 * 
	 * @return An ArrayList of undirected edges linked to this node in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 ...
	 * getLinkedListUndirectedNeighbourEdges(n) returns all the (-,n) and (n,-) undirected edges of this. 
	 * 
	 * @return A LinkedList of undirected edges linked to this node in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 ...
	 * getHashSetUndirectedNeighbourEdges(n) returns all the (-,n) and (n,-) undirected edges of this. 
	 * 
	 * @return An HashSet of undirected edges linked to this node in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	...
	/**
	 * @return The number of undirected edges linked to n in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	private boolean fillWithUndirectedNeighbourNodes(Integer n, Collection<Integer> col){
		Set<Arc> l = getUndirectedNeighours(n);
		if(l == null)
			return false;
		for(Arc a : l)
	...
	/**
	 * @return An ArrayList containing the nodes m linked 
	 * to the node n with a undirected (n,m) or (m,n) edge,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	 ...
	 * @param n
	 * @return An HashSet of directed and undirected arcs linked to the node n in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	 ...
	 * 
	 * @param n
	 * @return The number of arcs (directed and undirected) linked to the node n in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	public int getAllNeighboursSize(Integer n) {
		return this.getInputSize(n)+this.getOutputSize(n)+this.getUndirectedNeighbourSize(n);
	}

	/**
	 * 
	 * @param n
	 * @return An iterator over all the arcs (directed and undirected) linked to the node n in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	 ...
	 * 
	 * @param n
	 * @return An HashSet of nodes linked with directed and undirected arcs to the node n in this,
	 * null if n does not belong to this graph,
	 * or is virtually removed.
	 */
	...
	/*
	 * ---------------------------------------------
	 * Add and remove vertices, edges and arcs
	 * ---------------------------------------------
	 */

	/**
	 * Add node to this (unless it already contains it). This node is not linked to
	 * any other node of this.
	...
	public boolean addVertice(int node) {
		if(links.containsKey(node))
			return false;
		Triplet<Set<Arc>,Set<Arc>,Set<Arc>> nodeLinks = 
				new Triplet<Set<Arc>, Set<Arc>, Set<Arc>>(
	...
	/**
	 * Remove node from this (unless it do not contains it). Remove also every arcs and edges
	 * linked to it.
	 * <br/>
	 * 
	 * @param node
	 * @return true if the vertice was removed, false if the node was null or not in the graph,
	 * or if it was virtually removed.
	 */
	...
	/**
	 * Add the (input,output) directed arc to this and return it. 
	 * Return null and do nothing if input or output does not belong to this
	 * or if the arc was already added or virtually removed.
	 * 
	 * @param input Input node of the added arc
	 * @param output Output node of the added arc
	 * @return The new (input, output) directed arc,
	 * null if input or output does not belong to this.
	 */
	...
	/**
	 * 
	 * Add the (input,output) directed arc to this for each node output in outputs and returns
	 * the list of added arcs. If input does not belong to this, a empty list is returned. For
	 * each output node in outputs which does not belong to this, the arc is not added neither
	 * to the graph nor to the returned list. 
	 * 
	 * @param input Input node of each added arc
	 * @param outputs List of output nodes of all added arcs.
	...
	/**
	 * Remove every directed arc (input, output) in this. Do nothing if
	 * input or output does not belong to this.
	 * <br/>.
	 * @param input
	 * @param output
	 */
	...
	/**
	 * Add the (n1,n2) undirected arc to this and return it.
	 * Return null and do nothing if input or output does not belong to this or 
	 * if the arc was already added or virtually removed.
	 * 
	 * @param n1 First end node of the added arc
	 * @param n2 Second end node of the added arc
	 * @return The new (n1,n2) undirected arc, null
	...
	/**
	 * Add the (n1,n2) undirected arc to this for each node n2 in n2s and return the list
	 * of added arcs. If n1 does not belong to this, a empty list is returned. For
	 * each n2 node in n2s which does not belong to this, the arc is not added neither
	 * to the graph nor to the returned list. 
	 * 
	 * @param n1 First end node of each added arc
	 * @param n2s List of second end node of all added arc
	...
	/**
	 * Remove every undirected arc linking nodes n1 and n2 in this. Do nothing if
	 * n1 or n2t does not belong to this.
	 * <br/>
	 * @param n1
	 * @param n2 
	 */
	 ...
	 * (including (n2,n1) directed arcs). Do nothing if
	 * n1 or n2 does not belong to this.
	 * @param n1
	 * @param n2
	 */
	 ...
	 * 
	 * @return True if the arc or edge was successfully removed, False if a does not belong to this
	 * or if it was virtually removed.
	 */
	...
	/**
	 * Link n1 and n2 by a arc (n1,n2), add the arc to this and return it. 
	 * If directed is true, the arc is directed, else it is directed. Return
	 * null if n1 or n2 do not belong to this graph. 
	 * @param n1
	 * @param n2
	 * @param directed
	 * @return A new arc in this linking n1 to n2, null if n1 or n2 do not belong to this graph or 
	 * if a was already added or virtually removed.
	 */
	...
	/**
	 * Remove every link between nodes n1 and n2. Remove directed arcs if directed is True,
	 * undirected if not. Do nothing if
	 * n1 or n2 does not belong to this.
	 * <br/>
	 * 
	 * @param n1
	 * @param n2
	 * @param directed
	 * @throws NodeNotContainedException If n1 or n2 does not belong to this.
	 */
	...
	/*
	 * ---------------------------------------------
	 * Virtually removed vertices, edges and arcs
	 * ---------------------------------------------
	 */

	/**
	 * Virtually remove the vertice from the graph. The vertice
	 * will not appear anymore while reading the vertices of the
	 * graph (by listing the vertices, or reading the neighbour of
	 * any node).
	 * Every arc containing n is also virtually removed from this.
	 * <br/>
	 * 
	 * @param n The node to be virtually removed.
	 * @return True if the node was virtually removed from this. False if it
	 * was null, it does not belong to this, or if it was already virtually removed.
	...
	/**
	 * Cancel the virtually removal of n.
	 * <br/>
	 * @param n
	 * @return True if cancelling succeed. False if it
	 * was null, it does not belong to this, or if it was not virtually removed.
	...
	/**
	 * Virtually remove the edge from the graph. The edge
	 * will not appear anymore while reading the edges of the
	 * graph (by listing the edges, or reading the neighbour of
	 * any node).
	 * <br/>
	 * @param a The edge to be virtually removed.
	 * @return True if the edge was virtually removed from this. False if it
	 * was null, it does not belong to this, or if it was already virtually removed.
	 * {@link #cancelVirtuallyRemoveEdge(Arc)}
	 */
	...
	/**
	 * Cancel the virtually removal of a. Do not work is one of the edges is virtually removed.
	 * <br/>
	 * @param a
	 * @return True if cancelling succeed. False if it
	 * was null, it does not belong to this, if it was not virtually removed
	 * or if one of its ends it virtually removed.
	 * {@link #virtuallyRemoveEdge(Arc)}
	 */
	public boolean cancelVirtuallyRemoveEdge(Arc a){
		if(a == null 
				|| this.hasVirtuallyRemoved(a.getInput()) 
	 ...
	 * Do not show the set of edges virtually removed
	 * when one of their ends was removed.
	 * 
	 * 
	 * @return The set of virtually removed edges and arcs,
	 * 
	...
	/**
	 * @param a
	 * @return True if a was virtually removed from this, or if one of
	 * its ends was virtually removed.
	 */
	public boolean hasVirtuallyRemoved(Arc a){
		return a != null && (vrmEdges.contains(a) 
				|| vrmVertices.contains(a.getInput()) 
				|| vrmVertices.contains(a.getOutput()));
	}
	...
	/**
	 * @param n
	 * @return The connected component of this containing the node n,
	...
	/**
	 * Return true if a path connecting n1 and n2 exists in this. This path
	 * can use only undirected edges.
	 * 
	 * @param n1
	 * @param n2
	 * @return true if a undirected path connecting n1 and n2 exists in this. False if not
	 ...
	 * 
	 * Return true if a path connecting n1 and n2 exists in this. This path
	 * can use only directed edges.
	 * 
	 * @param n1
	 * @param n2
	 * @return true if a directed path from n1 to n2 exists in this.  False if not
	 * or if n1 or n2 do not belong to this.
	 */
	...
	/**
	 * Return true if a path connecting n1 and n2 exists in this. This path
	 * can use directed and undirected edges.
	 * 
	 * @param n1
	 * @param n2
	...
	/**
	 * Return true if a path connecting n1 and n2 exists in this. This path
	 * can use directed edges if useDirected is true and undirected edges
	 * if use undirected is true.
	 * 
	 * @param n1
	 * @param n2
	 * @param useUndirected
	 * @param useDirected
	 * @return true if a path connecting n1 and n2 exists in this while respecting
	 * useUndirected and useDirected. False if not or if n1 or n2 do not belong to this.
	 */
	private boolean areConnected(Integer n1, Integer n2, boolean useUndirected, boolean useDirected) {
		...
		while (!l.isEmpty()) {
			...
			h.add(u);
			it = new MultiIterator<Arc>(
					this.getOutputArcsIterator(u),
	...
	/**
	 * Return a path connecting n1 and n2 if it exists, null if it doed not. This path
	 * can use only undirected edges.
	 * 
	 * @param n1
	 * @param n2
	 ...
	 * useUndirected and useDirected. False if not or if n1 or n2 do not belong to this.
	 */
	private ArrayList<Arc> getPathConnecting(Integer n1, Integer n2, boolean useUndirected, boolean useDirected){
	 ...
	 * least number of edges as possible. Return null if n1 or n2 does not
	 * belong to this.
	 */
	...
	/**
	 * 
	 * Return every successive node layers from n1 to n2; 
	 * or null if n1 or n2 does not belong to this or if this 
	 * does not contain any path from n1 to n2.
	 * 
	 * If a node n belongs to layer i, there is minimum number
	 * of edges path from n1 to in with i edges.
	 * 
	 * If checkOrientation is true, the path check orientation of
	 * directed arcs. For example, in the graph n1 --> n3 <-- n2, the
	 * algorithm returns null if checkOrientation is true, and [[n1],[n3],[n2]]
	 * if not. 
	 * 
	 * 
	 * @param n1
	 ...
	 * does not contain any path from n1 to n2.
	 * 
	 * If isDirected is true, if a node n belongs to layer i, there is minimum number
	 * of arcs directed path from n1 to in with i arcs.
	 * If isDirected is false, if a node n belongs to layer i, there is minimum number
	 * of edges undirected path from n1 to in with i edges.
	 * 
	 * 
	 * @param n1
	 * @param n2
	 ...
	 * 
	 */
	public ArrayList<ArrayList<Integer>> getNodeLayersWithSpecificArcs(Integer n1,
			Integer n2, final boolean isDirected) {
		return getNodeLayers(n1, n2,
				new Foncteur<Couple<Integer, Arc>, Boolean>() {
	...
	/**
	 * @param v
	 * @return One cycle in this containing v. Return null if v
			...
			while(it.hasNext()){
				...
				if(w.equals(v)){
					...
					while(!u.equals(v)){
						...
						while(it2.hasNext()){
							w = it2.next().getInput();
							if(depth.get(w) != null && (depth.get(w).equals(depth.get(u) - 1))){
								u = w;
								break;
							}
						}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T extends Graph> T getInducedGraphFromArc(
			Collection<Arc> arcs) {
	...
	/**
	 * Renvoie une copie de ce graphe, équivalent à un appel de 
	 * getInducedFrom avec tous les noeuds.
	 * @return
	 */
	public Graph copy(){
