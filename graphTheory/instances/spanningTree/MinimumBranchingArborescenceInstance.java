...
/**
 * Instance of the minimum branching arborescence problem : given a graph
 * and one node {@link #root} of that graph, and weight over
 * the arcs, return the minimum cost directed tree rooted in {@link #root} spanning
 * all the other nodes.
 * 
