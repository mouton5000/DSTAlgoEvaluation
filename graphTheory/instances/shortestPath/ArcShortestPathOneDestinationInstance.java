...
/**
 * Instance of the shortest path problem : given a graph
 * and one node {@link #destination} of that graph, and weight over
 * the arcs, return the shortest paths to {@link #destination} from all nodes.
 * 
