...
/**        
 * An algorithm is an object we build with inputs, 
 * then we run it, and then we check the outputs.
 * 
...
public abstract class Algorithm {
	...
	/**
	 * Run the algorithm over the instance (without checking the instance has a solution, and
	 * without checking the running time)
	 */
	protected abstract void computeWithoutTime();

	/**
	 * If false, this algorithm does not check if the current instance has a solution.
