...
/**
 * 
 * The minimum branching problem asks, in a directed weighted graph containing a specific
 * node r, for a directed tree rooted in r spanning all the graph at minimum cost.
 * 
 * A MinimumBranchingAlgorithm instance is an algorithm which solve the minimum branching problem
 * instances.
 * 
...
public abstract class MinimumBranchingAlgorithm extends Algorithm implements Cloneable{
